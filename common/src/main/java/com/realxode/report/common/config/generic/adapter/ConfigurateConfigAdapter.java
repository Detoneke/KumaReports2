package com.realxode.report.common.config.generic.adapter;
...
public abstract class ConfigurateConfigAdapter implements ConfigurationAdapter {
    ...
    public ConfigurateConfigAdapter(KumaPlugin plugin, Path path) {
        this.plugin = plugin;
        this.path = path;
        reload();
    }
    ...
    private @NotNull ConfigurationNode resolvePath(String path) {
        if (this.root == null) {
