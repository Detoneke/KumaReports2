...
import com.realxode.report.common.config.generic.adapter.types.yaml.utils.NumberConversions;
...
public class MemorySection implements ConfigurationSection {
    ...
    public ConfigurationSection createSection(final String path, final @NotNull Map<?, ?> map) {
