...
import com.realxode.report.common.config.generic.adapter.types.yaml.ConfigurationOptions;
...
public class KeyTree {
    ...
    private @NotNull Node findParent(final @NotNull Node parent, final int indent) {
    ...
    public class Node {
        ...
        @Contract("_ -> param1")
        private @NotNull Node add(final Node child) {
